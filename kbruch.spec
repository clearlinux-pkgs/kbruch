...
Version  : 24.08.1
Release  : 74
URL      : https://download.kde.org/stable/release-service/24.08.1/src/kbruch-24.08.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.08.1/src/kbruch-24.08.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.1/src/kbruch-24.08.1.tar.xz.sig
...
%setup -q -n kbruch-24.08.1
cd %{_builddir}/kbruch-24.08.1
pushd ..
cp -a kbruch-24.08.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726189759
mkdir -p clr-build
pushd clr-build
