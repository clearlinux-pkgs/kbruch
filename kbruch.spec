...
Source0  : https://download.kde.org/stable/release-service/24.05.2/src/kbruch-24.05.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.2/src/kbruch-24.05.2.tar.xz.sig
...
%setup -q -n kbruch-24.05.2
cd %{_builddir}/kbruch-24.05.2
pushd ..
cp -a kbruch-24.05.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720586452
mkdir -p clr-build
pushd clr-build
