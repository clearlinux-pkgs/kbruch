...
Source0  : https://download.kde.org/stable/release-service/19.12.2/src/kbruch-19.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/19.12.2/src/kbruch-19.12.2.tar.xz.sig
...
%prep
%setup -q -n kbruch-19.12.2
cd %{_builddir}/kbruch-19.12.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1581016579
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kbruch-19.12.2/COPYING %{buildroot}/usr/share/package-licenses/kbruch/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
cp %{_builddir}/kbruch-19.12.2/COPYING.DOC %{buildroot}/usr/share/package-licenses/kbruch/1bd373e4851a93027ba70064bd7dbdc6827147e1
pushd clr-build
%make_install
popd
%find_lang kbruch
