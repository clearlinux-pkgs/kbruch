...
Version  : 23.04.3
Release  : 56
URL      : https://download.kde.org/stable/release-service/23.04.3/src/kbruch-23.04.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.04.3/src/kbruch-23.04.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.3/src/kbruch-23.04.3.tar.xz.sig
...
%prep
%setup -q -n kbruch-23.04.3
cd %{_builddir}/kbruch-23.04.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1688860308
mkdir -p clr-build
pushd clr-build
