...
Version  : 24.02.1
Release  : 65
URL      : https://download.kde.org/stable/release-service/24.02.1/src/kbruch-24.02.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.02.1/src/kbruch-24.02.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.1/src/kbruch-24.02.1.tar.xz.sig
...
%prep
%setup -q -n kbruch-24.02.1
cd %{_builddir}/kbruch-24.02.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711082201
mkdir -p clr-build
pushd clr-build
