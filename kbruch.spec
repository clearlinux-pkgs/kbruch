...
Version  : 23.08.2
Release  : 59
URL      : https://download.kde.org/stable/release-service/23.08.2/src/kbruch-23.08.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.08.2/src/kbruch-23.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.2/src/kbruch-23.08.2.tar.xz.sig
...
%prep
%setup -q -n kbruch-23.08.2
cd %{_builddir}/kbruch-23.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697256292
mkdir -p clr-build
pushd clr-build
